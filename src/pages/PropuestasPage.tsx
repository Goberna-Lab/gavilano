...
function PropuestasPage() {
  return (
    <>
      <section className="propuestas-page" aria-labelledby="propuestas-page-title">
        <p className="propuestas-page-kicker">MIS PROPUESTAS 2026 — 2030</p>

        <h1 className="propuestas-page-title" id="propuestas-page-title">
          <span>ORDEN Y</span>
        ...
        <p className="propuestas-page-copy">
          <strong>Quiero un distrito donde los vecinos vivan tranquilos,</strong> donde la municipalidad funcione, llegue y proteja a cada familia. Un distrito que vuelva al camino del desarrollo.
        </p>
      </section>
      ...
      <section className="propuestas-detail" aria-labelledby="propuestas-detail-title">
        ...
        <article className="propuestas-detail-copy">
          <h2 className="propuestas-detail-title" id="propuestas-detail-title">
